...
def make_scrollable_text(parent):
    ...
    text_widget = ctk.CTkTextbox(text_frame, wrap="word", bg="white", fg="black", font=("Consolas", 15), relief=tk.FLAT)
...
def launch_gui(context):
    ...
    ip_label = ctk.CTkLabel(root, text=f"🌐 IDE IP: {context.local_ip}", font=("Arial", 15))
    ...
    style = ttk.Style()
    style.configure('TNotebook.Tab', font=('Arial', '16', 'bold'))  # Increase font size here
